...
public class ActivitySetWenesday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHelp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new TapTargetSequence(ActivitySetWenesday.this)
                        .targets(
        ...
        btnThurs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivitySetWenesday.this, ActivitySetThursday.class);
