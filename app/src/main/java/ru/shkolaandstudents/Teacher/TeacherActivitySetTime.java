...
public class TeacherActivitySetTime extends AppCompatActivity {
    ...
    Utilities utils = new Utilities(TeacherActivitySetTime.this);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final SharedPreferences prefs = this.getSharedPreferences("prefs2", MODE_PRIVATE);
        boolean firstStart = prefs.getBoolean("firstStart2", true);
        if(firstStart) {
            new TapTargetSequence(TeacherActivitySetTime.this)
                    .targets(
        ...
        SP = PreferenceManager.getDefaultSharedPreferences(TeacherActivitySetTime.this);
        SPEditor = SP.edit();

        FirebaseDatabase database = FirebaseDatabase.getInstance();
        reff = database.getReference("Users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Time");
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                reff = FirebaseDatabase.getInstance().getReference("Users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Time");
                if(T11.length()!=0) {
                ...
                //utils.switchFragment(TeacherActivitySetTime.this, new TeacherFragmentSettingStudy());
                Intent intent = new Intent(TeacherActivitySetTime.this, TeacherMainActivity.class);
