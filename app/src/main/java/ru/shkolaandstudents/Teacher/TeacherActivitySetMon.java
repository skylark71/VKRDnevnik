...
public class TeacherActivitySetMon extends AppCompatActivity {

    Utilities utils = new Utilities(TeacherActivitySetMon.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teacher_activity_set_monday);
        ...
        final TextView tvSetM1Sub = findViewById(R.id.tvSetM1Sub);
        final TextView tvSetM2Sub = findViewById(R.id.tvSetM2Sub);
        final TextView tvSetM3Sub = findViewById(R.id.tvSetM3Sub);
        final TextView tvSetM4Sub = findViewById(R.id.tvSetM4Sub);
        final TextView tvSetM5Sub = findViewById(R.id.tvSetM5Sub);
        final TextView tvSetM6Sub = findViewById(R.id.tvSetM6Sub);
        final TextView tvSetM7Sub = findViewById(R.id.tvSetM7Sub);
        final TextView tvSetM8Sub = findViewById(R.id.tvSetM8Sub);

        final TextView tvSetM1Class = findViewById(R.id.tvSetM1Class);
        final TextView tvSetM2Class = findViewById(R.id.tvSetM2Class);
        final TextView tvSetM3Class = findViewById(R.id.tvSetM3Class);
        final TextView tvSetM4Class = findViewById(R.id.tvSetM4Class);
        final TextView tvSetM5Class = findViewById(R.id.tvSetM5Class);
        final TextView tvSetM6Class = findViewById(R.id.tvSetM6Class);
        final TextView tvSetM7Class = findViewById(R.id.tvSetM7Class);
        final TextView tvSetM8Class = findViewById(R.id.tvSetM8Class);

        ImageView delSetM1Sub = findViewById(R.id.delSetM1Sub);
        ...
        ImageView delSetM2Sub = findViewById(R.id.delSetM2Sub);
        ...
        ImageView delSetM3Sub = findViewById(R.id.delSetM3Sub);
        ...
        ImageView delSetM4Sub = findViewById(R.id.delSetM4Sub);
        ...
        ImageView delSetM5Sub = findViewById(R.id.delSetM5Sub);
        ...
        ImageView delSetM6Sub = findViewById(R.id.delSetM6Sub);
        ...
        ImageView delSetM7Sub = findViewById(R.id.delSetM7Sub);
        ...
        ImageView delSetM8Sub = findViewById(R.id.delSetM8Sub);
        ...
        ref1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                final ArrayAdapter arrayAdapterClass = new ArrayAdapter(TeacherActivitySetMon.this, android.R.layout.simple_spinner_item, strClass);

                {
                    ...
                    tvSetM1Class.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View vw) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(TeacherActivitySetMon.this, R.style.AlertDialogTheme);
                            ...
                            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    Toast.makeText(TeacherActivitySetMon.this, spinner.getSelectedItem().toString(), Toast.LENGTH_SHORT).show();
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                final ArrayAdapter arrayAdapterSub = new ArrayAdapter(TeacherActivitySetMon.this, android.R.layout.simple_spinner_item, strSub);
        ...
        btnTuesday.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //utils.switchFragment(TeacherActivitySetMon.this, new TeacherFragmentSettingStudy());
                Intent intent = new Intent(TeacherActivitySetMon.this, TeacherMainActivity.class);
        ...
        btnHelp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                /*new TapTargetSequence(TeacherActivitySetMon.this)
                        .targets(
