...
public class TeacherActivitySetFri extends AppCompatActivity {

    Button btnSat, btnHelp;
    DatabaseReference ref;
    DatabaseReference ref_save;

    Utilities utils = new Utilities(TeacherActivitySetFri.this);

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.teacher_activity_set_friday);
        ...
        final TextView tvSetFr1Sub = findViewById(R.id.tvSetFr1Sub);
        final TextView tvSetFr2Sub = findViewById(R.id.tvSetFr2Sub);
        final TextView tvSetFr3Sub = findViewById(R.id.tvSetFr3Sub);
        final TextView tvSetFr4Sub = findViewById(R.id.tvSetFr4Sub);
        final TextView tvSetFr5Sub = findViewById(R.id.tvSetFr5Sub);
        final TextView tvSetFr6Sub = findViewById(R.id.tvSetFr6Sub);
        final TextView tvSetFr7Sub = findViewById(R.id.tvSetFr7Sub);
        final TextView tvSetFr8Sub = findViewById(R.id.tvSetFr8Sub);

        final TextView tvSetFr1Class = findViewById(R.id.tvSetFr1Class);
        final TextView tvSetFr2Class = findViewById(R.id.tvSetFr2Class);
        final TextView tvSetFr3Class = findViewById(R.id.tvSetFr3Class);
        final TextView tvSetFr4Class = findViewById(R.id.tvSetFr4Class);
        final TextView tvSetFr5Class = findViewById(R.id.tvSetFr5Class);
        final TextView tvSetFr6Class = findViewById(R.id.tvSetFr6Class);
        final TextView tvSetFr7Class = findViewById(R.id.tvSetFr7Class);
        final TextView tvSetFr8Class = findViewById(R.id.tvSetFr8Class);

        ImageView delSetFr1Sub = findViewById(R.id.delSetFr1Sub);
        ...
        ImageView delSetFr2Sub = findViewById(R.id.delSetFr2Sub);
        ...
        ImageView delSetFr3Sub = findViewById(R.id.delSetFr3Sub);
        ...
        ImageView delSetFr4Sub = findViewById(R.id.delSetFr4Sub);
        ...
        ImageView delSetFr5Sub = findViewById(R.id.delSetFr5Sub);
        ...
        ImageView delSetFr6Sub = findViewById(R.id.delSetFr6Sub);
        ...
        ImageView delSetFr7Sub = findViewById(R.id.delSetFr7Sub);
        ...
        ImageView delSetFr8Sub = findViewById(R.id.delSetFr8Sub);
        ...
        reff1.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                final ArrayAdapter arrayAdapterClass = new ArrayAdapter(TeacherActivitySetFri.this, android.R.layout.simple_spinner_item, strClass);

                {
                    ...
                    tvSetFr1Class.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View vw) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(TeacherActivitySetFri.this, R.style.AlertDialogTheme);
                            ...
                            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    Toast.makeText(TeacherActivitySetFri.this, spinner.getSelectedItem().toString(), Toast.LENGTH_SHORT).show();
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                final ArrayAdapter arrayAdapterSub = new ArrayAdapter(TeacherActivitySetFri.this, android.R.layout.simple_spinner_item, strSub);
        ...
        btnSat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //utils.switchFragment(TeacherActivitySetFri.this, new TeacherFragmentSettingStudy());
                Intent intent = new Intent(TeacherActivitySetFri.this, TeacherMainActivity.class);
        ...
        btnHelp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                /*new TapTargetSequence(TeacherActivitySetFri.this)
                        .targets(
