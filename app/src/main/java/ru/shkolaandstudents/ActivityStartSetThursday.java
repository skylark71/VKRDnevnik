...
public class ActivityStartSetThursday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHelp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new TapTargetSequence(ActivityStartSetThursday.this)
                        .targets(
        ...
        btnFri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityStartSetThursday.this, ActivityStartSetFriday.class);
