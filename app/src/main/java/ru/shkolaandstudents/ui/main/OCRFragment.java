...
public class OCRFragment extends Fragment {
    ...
    /**
     * Подзаголовок экрана распознавания текста.
     */
    private TextView ocrResultPodHeader;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        ocrResultPodHeader = rootView.findViewById(R.id.ocrResultPodHeader);
    ...
    class OCRProgress extends AsyncTask<Integer, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            ocrResultPodHeader.setVisibility(View.VISIBLE);
