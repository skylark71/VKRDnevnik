...
public class ActivityStartSetTime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Intent intent = new Intent(ActivityStartSetTime.this, MainActivity.class);
    ...
    {
        new TapTargetSequence(ActivityStartSetTime.this)
                .targets(
