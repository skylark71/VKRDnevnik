...
public class ActivityStartSetTuesday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHelp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new TapTargetSequence(ActivityStartSetTuesday.this)
                        .targets(
        ...
        btnWend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityStartSetTuesday.this, ActivityStartSetWenesday.class);
